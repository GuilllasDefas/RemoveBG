...
class ProcessadorLote:
    def __init__(self, removedor_fundo, pasta_origem, pasta_destino, callback_progresso=None):
    ...
    def processar(self, usar_alpha_matting=True, limiar_objeto=250, 
                limiar_fundo=10, tamanho_erosao=5):
        ...
        for i, nome_arquivo in enumerate(imagens):
            ...
            nome_saida = f"{nome_base}_{self.removedor_fundo.nome_modelo}_sem_fundo.png"
        ...
        return self.arquivos_processados, total_arquivos, self.arquivos_com_erro
